...
function showData(subject) {
    d3.json("data/stocks.json").then((importedData) => {
        ...
        stockInfo.html("<h5><b>Company Name: </b>{{apple}}</h5> <br><b>Open Price:</b>variable goes here <br><br><b>High: </b>variable goes here <br><br><b>Low: </b>variable goes here <br><br><b>Close Price: </b>variable goes here <br><br><b>Volume: </b>variable goes here");
        });
    });
}
