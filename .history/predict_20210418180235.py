...
def make_prediction(tick="AMZN", days=1):
    ...
    # Below are the variables that manipulate the functionality of the above functions that create the model and make the predictions
    # It should be noted that adjusting these in a trial and error approach will lead the maximum efficiency 
    ...
    return final_df, future_price, accuracy_score, loss, mean_absolute_error